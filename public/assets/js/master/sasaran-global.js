$(function () {
  ...
  var tujuan_global = $("#tujuan_global");
  tujuan_global.select2({
    // theme: 'bootstrap4',
    placeholder: "Pilih Tujuan Global",
  });

  var tujuan_global_search = $("#tujuan_global_select");
  tujuan_global_search.select2({
    // theme: 'bootstrap4',
    placeholder: "Pilih Tujuan Global",
  });

  var url = $("#table_sasaranglobal").data("url");
  var table = $("#table_sasaranglobal").DataTable({
    processing: true,
    serverSide: true,
    bFilter: false,
    language: {
    ...
    ajax: {
      ...
      data: function (d) {
        ...
        d.tujuan_select = $("select#tujuan_global_select option:checked").val();
      },
    },
    columns: [
      {
      ...
      {
        data: "kode_sasaran_global",
        name: "kode_sasaran_global",
      },
      {
        data: "nama_sasaran_global",
        name: "nama_sasaran_global",
      },
    ],
  });
  ...
  $("#createNewData").click(function () {
    ...
    $("#created").html("Sasaran Global");
    $("#updated").html("");
    $("#saveBtn").text("Simpan");
    $("#kode_sasaran_global").attr("disabled", false);
  });
  ...
  $("body").on("click", "#editData", function (e) {
    ...
    $.get(uri, function (data) {
      ...
      $("#ajaxModel").modal("show");
      $("#data_id").val(data.id);
      $("#kode_sasaran_global").val(data.kode_sasaran_global);
      $("#nama_sasaran_global").val(data.nama_sasaran_global);
      $("#tujuan_global").val(data.id_tujuan_global).trigger("change");
      $("#keterangan").val(data.keterangan);
      $("#kode_sasaran_global").attr("disabled", true);
    });
  });
  ...
  $("body").on("click", "#detailData", function (e) {
    ...
    $.get(uri, function (data) {
      ...
      $("#kode_sasaran_globalD").html(data.kode_sasaran_global);
      $("#nama_sasaran_globalD").html(data.nama_sasaran_global);
  ...
  $("#saveBtn").click(function (e) {
    ...
    $.ajax({
      ...
      error: function (data) {
        ...
        message = data.responseJSON.errors.kode_sasaran_global;
  ...
  var url_switch = $("#table_sasaranglobal").data("switchurl");
