$(function () {
  ...
  var url = $("#table_tujuanglobal").data("url");
  var table = $("#table_tujuanglobal").DataTable({
    processing: true,
    serverSide: true,
    bFilter: false,
    language: {
    ...
    columns: [
      ...
      {
        data: "kode_tujuan_global",
        name: "kode_tujuan_global",
      },
      {
        data: "nama_tujuan_global",
        name: "nama_tujuan_global",
      },
    ],
  });
  ...
  $("body").on("click", "#editData", function (e) {
    ...
    $.get(uri, function (data) {
      ...
      $("#ajaxModel").modal("show");
      $("#data_id").val(data.id);
      $("#kode_tujuan_global").val(data.kode_tujuan_global);
      $("#nama_tujuan_global").val(data.nama_tujuan_global);
      $("#kode_tujuan_global").attr("disabled", true);
    });
  });
  ...
  $("body").on("click", "#detailData", function (e) {
    ...
    $.get(uri, function (data) {
      ...
      $("#kode_tujuan_globalD").html(data.kode_tujuan_global_detail);
      $("#nama_tujuan_globalD").html(data.nama_tujuan_global_detail);
  ...
  var url_switch = $("#table_tujuanglobal").data("switchurl");
