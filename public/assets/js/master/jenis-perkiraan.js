$(function () {
  ...
  var url = $("#table_jenisperkiraan").data("url");
  var table = $("#table_jenisperkiraan").DataTable({
    processing: true,
    serverSide: true,
    bFilter: false,
    language: {
    ...
    ajax: {
      url: url,
      data: function (d) {
        d.kode_perkiraan_search = $("input[name=kode_perkiraan_search]").val();
    ...
    columns: [
      ...
      {
        data: "kode_jenis_perkiraan",
        name: "kode_jenis_perkiraan",
      },
      {
  ...
  $("#createNewData").click(function () {
    ...
    $("#updated").html("");
    $("#saveBtn").text("Simpan");
    $("#kode_jenis_perkiraan").attr("disabled", false);
  });
  ...
  $("body").on("click", "#editData", function (e) {
    ...
    $.get(uri, function (data) {
      ...
      $("#ajaxModel").modal("show");
      $("#data_id").val(data.id);
      $("#kode_jenis_perkiraan").val(data.kode_jenis_perkiraan);
      $("#jenis_perkiraan").val(data.jenis_perkiraan);
      $("#keterangan").val(data.keterangan);
      $("#kode_jenis_perkiraan").attr("disabled", true);
    });
  });
  ...
  $("body").on("click", "#detailData", function (e) {
    ...
    $.get(uri, function (data) {
      ...
      $("#kode_jenis_perkiraanD").html(data.kode_jenis_perkiraan);
      $("#jenis_perkiraanD").html(data.jenis_perkiraan);
  ...
  $("#saveBtn").click(function (e) {
    ...
    $.ajax({
      ...
      error: function (data) {
        ...
        message = data.responseJSON.errors.kode_jenis_perkiraan;
  ...
  var url_switch = $("#table_jenisperkiraan").data("switchurl");
